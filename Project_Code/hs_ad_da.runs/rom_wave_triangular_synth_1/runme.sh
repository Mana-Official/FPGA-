...
HD_PWD='D:/Desktoop/Studio_FPGA/DD1_AD_DA_HDMI/20_hs_ad_da/hs_ad_da.runs/rom_wave_triangular_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_wave_triangular.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_wave_triangular.tcl
