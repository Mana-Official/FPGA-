...
HD_PWD='D:/Desktoop/Studio_FPGA/DD1_AD_DA_HDMI/20_hs_ad_da/hs_ad_da.runs/ila_ram_datain_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_ram_datain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_ram_datain.tcl
