...
HD_PWD='D:/Desktoop/Studio_FPGA/DD1_AD_DA_HDMI/20_hs_ad_da/hs_ad_da.runs/vio_wave_select_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_wave_select.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_wave_select.tcl
